...
namespace _6miniaia
{
    public partial class Form1 : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            if (comboBox4.Text == "See the ID and the number of Properties  for owners with number of properties >= number_entered")
            {
                Quer5 f4 = new Quer5();
                f4.Show();
            }
            ...
            if (comboBox4.Text == "See all the Visits  that the Client you chose made")
            {
                Quer8 f4 = new Quer8();
                f4.Show();
            }
